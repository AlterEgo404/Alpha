...
async def stats(ctx, member: discord.Member = None):
    ...
    AD = "<:AD:1426154602335698974>"
    AP = "<:AP:1426153499766427679>"
    Armor = "<:Armor:1426153517609127966>"
    ...
    embed.add_field(name = f"", value = f":AD:\n{ad}", inline = True)
    embed.add_field(name = f"", value = f":AP:\n{ap}", inline = True)
    embed.add_field(name = f"", value = f":Armor:\n{armor}", inline = True)
    embed.add_field(name = f"", value = f":MR:\n{magic_resist}", inline = True)
    embed.add_field(name = f"", value = f":AS:\n{attack_speed}", inline = True)
    embed.add_field(name="", value="", inline=False)
    embed.add_field(name = f"", value = f":CD:\n{lifesteal}%", inline = True)
    embed.add_field(name = f"", value = f":CC:\n{crit_rate}%", inline = True)
    embed.add_field(name = f"", value = f":SV:\n{lifesteal}%", inline = True)
    embed.add_field(name = f"", value = f":DA:\n{amplify}%", inline = True)
    embed.add_field(name = f"", value = f":DR:\n{resistance}%", inline = True)
